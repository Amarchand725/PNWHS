...
class PromotedMember extends Model
{
	...
	protected $fillable = [
        'id','created_by', 'member_id', 'promoted_rank_id', 'rank_rate', 'file_registration_no', 'old_p_no','new_p_no', 'soldier', 'd_o_p', 'd_o_sod', 'd_o_sos', 'd_o_s', 'total_service', 'gross_salary', 'created_at','updated_at'
    ];

	static function getValidationRules(){
    	$rules = [
		    'promoted_rank_id' => 'required', 'reg_file_no' => 'required', 'old_p_no' => 'required','new_p_no' => 'required','d_o_p' => 'required', 'd_o_sod' => 'required'
		];
		return $rules;
    }
