...
class GetProfit extends Model
{
	...
	protected $fillable = [
		...
		'payment_method', 'beneficiary_name', 'ref_cheque_no', 'bank_name', 'date', 'remarks', 'created_at','updated_at'
    ];
...
if(!empty(Input::get("updated_at"))){
	...
	{
		return $this->hasOne(PromotedMember::class, 'old_p_no', 'p_no')->orderby('id', 'DESC');
	}
}