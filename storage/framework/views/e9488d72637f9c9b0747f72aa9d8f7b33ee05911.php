                    ...
                    <div class='row'>
                        <div class='col-sm-12'>
                            <div style='float:right'>
                                <a href="<?php echo e(url('download_sheet_sample')); ?>" title='Download sheet sample from here.'><i class='fa fa-download'></i> Download Sheet Sample</a>
                            </div>
                        </div>
                    </div>

                    <!-- Monthly Record Sheet -->
                    <form class="form-horizontal" method="POST" action="<?php echo e(url('parse_file')); ?>" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="form-group<?php echo e($errors->has('csv_file') ? ' has-error' : ''); ?>">    
                                    ...
                                    <span id='error' style='color:red'><?php echo e($errors->first('csv_file')); ?></span>
