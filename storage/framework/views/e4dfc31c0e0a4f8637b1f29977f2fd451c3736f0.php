      ...
      <div class="panel-body">
        <div class="row">
          <div class="col-sm-10">
            <div class="form-group">
                ...
                <?php echo Form::number("p_no", null, ["class" => "form-control", "placeholder" => "Enter P/PJO/O No"]); ?>
        ...
        <?php if(isset($paid_amount)): ?>
            ...
            <table class="table">
                ...
                <tr>
                    <th>
                        <label for="" class='label label-primary'><?php echo e($profit_rate->rate); ?>%</label>
                    </th>
                    <th>
                        <label for="" class='label label-success'><?php echo e(number_format($paid_amount)); ?></label>
                    </th>
                    <th>
                        <label for="" class='label label-info'><?php echo e(number_format(($profit_rate->rate/100)*$paid_amount)); ?></label>
                    </th>
                    <th>
                        <label for="" class='label label-success'><?php echo e(number_format($paid_amount+($profit_rate->rate/100)*$paid_amount)); ?></label>
                    </th>
                </tr>
            </table>
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" readonly class="form-control" value="<?php echo e($p_no); ?>" name="p_no" id="">
                        <input type="hidden" class="form-control" value="<?php echo e($profit_rate->id); ?>" name="profit_rate_id" id="">
                        <input type="hidden" class="form-control" value="<?php echo e(($profit_rate->rate/100)*$paid_amount); ?>" name="profit_amount" id="">
                        <input type="hidden" class="form-control" value="<?php echo e($paid_amount); ?>" name="submitted_amount" id="">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="">Refundable Amount</label>
                        <input type="text" readonly class="form-control" value="<?php echo e(number_format($paid_amount+($profit_rate->rate/100)*$paid_amount)); ?>" name="refundable_amount" id="">
                    </div>
                </div>
                <!-- <div class="col-md-6">
                    <div class="form-group">
                ...
                <!-- <div class="col-md-6">
                    <div class="form-group">
                        <?php echo Form::label("reciever_name", "Reciever's Name:", ["class" => "control-label"]); ?>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <?php echo Form::label("reciver_relation", "Reciever's Relation:", ["class" => "control-label"]); ?>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <?php echo Form::label("reciver_cnic", "Reciever's CNIC:", ["class" => "control-label"]); ?>
