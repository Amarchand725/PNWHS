...
<html lang="en">
    <head>
        ...
        <link href="<?php echo e(asset('autocomplete/jquery-auto-complete.css')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('css/jquery-ui-1.10.3.css')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('css/bootstrap-timepicker.min.css')); ?>" rel="stylesheet">

        <link rel="stylesheet" type="text/css" href="<?php echo e(url('css/jquery.dataTables.css')); ?>">
        <link rel="stylesheet" type="text/css" href="<?php echo e(url('css/themeroller.css')); ?>">
        <script type="text/javascript" charset="utf8" src="<?php echo e(url('js/jquery-1.7.1.min.js')); ?>"></script>
        <script type="text/javascript" charset="utf8" src="<?php echo e(url('js/jquery.dataTables.min.js')); ?>"></script>
        ...
        <script src="<?php echo e(asset('autocomplete/jquery-auto-complete.js')); ?>"></script>
        <script src="<?php echo e(asset('js/jquery.autogrow-textarea.js')); ?>"></script>

        <!--Script for calender -->
        <link href="<?php echo e(asset('css/Calender/style.css')); ?>" rel="stylesheet">
        <script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.24.0/moment-with-locales.min.js"></script>
        <script src="<?php echo e(asset('js/Calender/Script.js')); ?>"></script>
        <!-- Bootstrap wizard progressbar -->
        <script src="<?php echo e(asset('')); ?>/js/bootstrap-wizard.min.js"></script>
