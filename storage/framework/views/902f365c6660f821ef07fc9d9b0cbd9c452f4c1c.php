...
<?php $__env->startSection('content'); ?>
  ...
  <?php echo $__env->make('allotteeDetailsOfKin._search', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <br>
  <?php
          ...
          <tbody class='ajax_content'>
            ...
            <?php $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <tr>
                ...
                <td>
                  <?php if(!empty($member->hasPromotedMember)): ?>
                    <?php echo e($member->hasPromotedMember->new_p_no); ?>

                  <?php else: ?>
                    <?php echo e($member->p_no); ?>

                  <?php endif; ?>
                </td>
                <td>
                  <?php echo e(ucfirst($member->hasUser->name??'--')); ?> | 
                  <?php if(!empty($member->hasPromotedMember)): ?>
                    <?php echo e($member->hasPromotedMember->hasPromotedRank->name??'--'); ?>

                  <?php else: ?>
                    <?php echo e($member->hasRank->name??'--'); ?>
                ...
                <td>
                  ...
                  ?>
                  <?php if(now()->diff($joining_date)->y >= 23): ?>
                    <span class='badge badge-success'><?php echo e(now()->diff($joining_date)->y); ?></span> - Year(s)
                  <?php else: ?>
                    <span class='badge badge-danger'><?php echo e(now()->diff($joining_date)->y); ?></span> - Year(s)
                  <?php endif; ?>
                </td>
                <td>
                  <?php echo e(date('F-Y', strtotime($member->membership_date))); ?>
                ...
                <td>
                  ...
                  ?>
                  <?php if(now()->diff($membership_date)->y >= 3): ?>
                    <span class='badge badge-success'><?php echo e(now()->diff($membership_date)->y); ?></span> - Year(s)
                  <?php else: ?>
                    <span class='badge badge-danger'><?php echo e(now()->diff($membership_date)->y); ?></span> - Year(s)
                  <?php endif; ?>
                </td>
                <td>
                  <span class='label label-info'>
                    <?php if(!empty($member->hasPayment)): ?>
                      <?php echo e($amount_converter->gettypenumber($member->hasPayment->amount)); ?>
                  ...
                  ?>
                  <?php if($house_price_in_percent >= 70): ?>
                    <span class='label label-success'><?php echo e($house_price_in_percent); ?>%</span>
                  <?php else: ?>
                    <span class='label label-danger'><?php echo e($house_price_in_percent); ?>%</span>
                  <?php endif; ?>
                </td>
                <td>
                  <?php if(!empty($member->hasMemberStatus) && $member->hasMemberStatus->is_active==1): ?>
                ...
                <td>
                  <?php if(now()->diff($joining_date)->y >= 23 && now()->diff($membership_date)->y >= 3 && $house_price_in_percent >= 70): ?>
                ...
                <td>
                  <a href="<?php echo e(url('Ledger', $member->p_no)); ?>" data-toggle="tooltip"  title="Paid Amount Details" class="btn btn-info btn-sm"><i class="fa fa-money"></i></a>
                  <a href="<?php echo e(url('allocate_house', $member->p_no)); ?>" data-toggle="tooltip"  title="Alocate House" class="btn btn-primary btn-sm"><i class="fa fa-home"></i></a>
                </td>
              </tr>
