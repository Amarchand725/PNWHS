            ...
            @if($user->userType->name != 'user')
                ...
                ">
                    ...
                    >
                        ...
                        <li class="{{ (request()->is('GetProfit')) ? 'active' : '' }}"><a href="{{url('/GetProfit')}}"><i class="fa fa-caret-right"></i>Manage Returned Fund</a></li>
                        <li class="{{ (request()->is('CsvData')) ? 'active' : '' }}"><a href="{{url('/CsvData')}}"><i class="fa fa-caret-right"></i>File's Payments</a></li>
                        <li class="{{ (request()->is('CsvFile')) ? 'active' : '' }}"><a href="{{url('/CsvFile')}}"><i class="fa fa-caret-right"></i>Manage Payment Sheets</a></li>
                        <li class="{{ (request()->is('import')) ? 'active' : '' }}"><a href="{{url('/import')}}" title='Upload Monthly or Six Month Sheet'><i class="fa fa-caret-right"></i>Upload Sheet</a></li>
