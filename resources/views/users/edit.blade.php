    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <?php  $usertype = DB::table('usertype')->pluck('name','id'); ?>
                        ...
                        {{ Form::select('user_type',$usertype, null, array('class' => 'form-control') ) }}
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                    <?php  $userroles = DB::table('userroles')->pluck('role','id'); ?>
					{!! Form::label("Userroles", "User Roles", ["class" => "control-label "]) !!}
					{!! Form::select('role',$userroles ,null, array('class' => 'form-control')) !!}
                    </div>
                </div>
            </div>
        </div>
