                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @if(!empty($model->hasPromotedMember))
                                    @if(!empty($model->hasPromotedMember->file_registration_no))
                                        <input type="number" name='reg_file_no' readonly class='form-control' id='reg_file_no' value='{{ $model->hasPromotedMember->file_registration_no }}'>
                                    @else
                                        <input type="number" name='reg_file_no' class='form-control' id='reg_file_no' value='{{ $model->hasPromotedMember->file_registration_no }}'>
                                    @endif
                                @elseif(!empty($model->reg_file_no))
                                    @if(!empty($model->reg_file_no))
                                        <input type="number" name='reg_file_no' readonly class='form-control' id='reg_file_no' value='{{ $model->reg_file_no }}'>
                                    @else
                                        <input type="number" name='reg_file_no' class='form-control' id='reg_file_no' value='{{ $model->reg_file_no }}'>
                                    @endif
                                @else
                        ...
                        @if($model->honu_p_no)
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="honu_p_no" class="form-control" value='{{ $model->honu_p_no }}' placeholder="Enter HONU PNo">
                                    ...
                                    <td>
                                        @if(!empty($model->hasAllotteeFiles->any_other_docs))
                                            @if(explode('.', $model->hasAllotteeFiles->any_other_docs)[1]=='pdf')
                                                <embed src="{{ url('/public/alloteefiles/'.$model->hasAllotteeFiles->any_other_docs) }}" type="application/pdf" style='height:300px; width:600px; margin-bottom: 5px;' />
                                            @else
