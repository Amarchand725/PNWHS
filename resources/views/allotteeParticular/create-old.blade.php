          ...
          <div class="basic-wizard">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane active" id="applicant-info">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <span style='color:red'>*</span>
                    <div class="form-group">
                      <input type="text" class='form-control' name='d_o_c' id='d_o_c_date' placeholder='select date of probationary completion' value='{{ old("d_o_c") }}' require>
              ...
              <div class="tab-pane" id="parent-info">
                <div class="row">
                  <div class="col-sm-12">
                    <div class="col-sm-6"><h3>Allottee Particular Next of Kin/Parent Details :</h3></div>
