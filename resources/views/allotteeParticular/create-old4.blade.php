  ...
  @section('content')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                              ...
                              {!! Form::number("reg_file_no", null, ["class" => "form-control", "id" => "reg_file_no", "readonly" => "readonly", "placeholder" => "Enter Registeration File No", 'required' => 'required']) !!}
    ...
    <Script>
      ...
      $('#d_o_sos_date').on('change', function(){
        ...
        if(date_of_probationary_completion==''){
            $('#service').val('( 0 year 0 month 0 days )');
            $('#error-sos').html('To calculate service enter date of probationary completion.');
