                ...
                <div class="tab-pane active" id="applicant-info">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @if(!empty($model->hasPromotedMember))
                                    <input type="number" class='form-control' value='{{ $model->hasPromotedMember->file_registration_no }}' name='reg_file_no' id='reg_file_no' require>
                                @else
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <span style='color:red'>*</span>
                                @if(!empty($model->hasPromotedMember))
                                    <input type="number" class='form-control' value='{{ $model->hasPromotedMember->new_p_no }}' name='p_no' id='p_no' require>
                                @else
                         ...
                         <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <span style='color:red'>*</span>
                              @if(!empty($model->hasPromotedMember))
                                <select class='form-control' name='rank_rate' id="rank-rate">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <input type="text" class='form-control' value='{{ $model->d_o_c }}' name='d_o_c'
                                    id='d_o_c_date'>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                @if(!empty($model->hasPromotedMember))
                                    <input type="text" class='form-control' value='{{ date("d-m-Y", strtotime($model->hasPromotedMember->d_o_p)) }}' name='d_o_p'
                                    id='d_o_p_date'>
                                @else
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                @if(!empty($model->hasPromotedMember))
                                    <input type="text" class='form-control' value='{{ date("d-m-Y", strtotime($model->hasPromotedMember->d_o_sod)) }}' name='d_o_sod'
                                    id='d_o_sod_date'>
                                @else
                                    <input type="text" class='form-control' value='{{ date("d-m-Y", strtotime($model->d_o_sod)) }}' name='d_o_sod'
                                    id='d_o_sod_date'>
                                @endif
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 civilian-input">
                            ...
                            <div class="form-group">
                                @if(!empty($model->hasPromotedMember))
                                    ...
                                    id='d_o_s_date'>
                                @else
                                    <input type="date" class='form-control' value='{{ $model->d_o_s }}' name='d_o_s'
                                    id='d_o_s_date'>
                                @endif
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <span style='color:red'> {{ $errors->first('total_service') }}</span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @if(!empty($model->hasPromotedMember))
                                    <input type="number" class='form-control' value='{{ $model->hasPromotedMember->gross_salary }}' name='salary' id='salary'>
                                @else
                                ...
                                <tbody id='transaction_tbody2'>
                                                ...
                                                <tr class='transaction_row2'>
                                                    ...
                                                    <td class="text-center">
                                                        <button type='button' data-key='{{ $key }}'
                                                            class='btn btn-success addMore2'><i class="fa fa-plus"></i></button>
                                                    </td>
                                                </tr>
                                            @else
                                                <tr class='transaction_row2'>
                                    ...
                                    @else
                                        <tr class='transaction_row2'>
                                            ...
                                            <td class="text-center">
                                                <button type='button' data-key='0' class='btn btn-success addMore2'><i
                                        ...
                                        <td>
                                            @if(!empty($model->hasAllotteeFiles->cnicback))
                                                @if(explode('.', $model->hasAllotteeFiles->cnicback)[1]=='pdf')
                                                    <embed src="{{ url('/public/alloteefiles/'.$model->hasAllotteeFiles->cnicback) }}" type="application/pdf" style='height:300px; width:600px; margin-bottom: 5px;' />
                                                @else
                            ...
                            @if(!empty($model->hasAllotteeKinsMultipleFiles))
                                @foreach($model->hasAllotteeKinsMultipleFiles as $key => $nextkinfile)
                                    @if($nextkinfile->fileposition=='nextofkinfilefront')
                                        <div class="col-sm-6">
                                            @if(explode('.', $nextkinfile->filetext[1]=='pdf'))
                                                <embed src="{{ url('/public/kinsfiles/') }}/{{ $nextkinfile->filetext }}" type="application/pdf" style='height:300px; width:600px; margin-bottom: 5px;' />
                                            @else
                                            ...
                                            <br /><br />
                                            <input type="file" style='margin-top: 10px; margin-bottom: 20px;' name="transactionform2[{{ $key }}][nextofkinfilefront]" class="form-control" id='nextofkinfilefront'>
                                        </div>
                                    @endif 
                                    ...
                                    @if($nextkinfile['fileposition']=='nextofkinfileback')
                                        <div class="col-sm-6">
                                            ...
                                            <br /><br />
                                            <input type="file" style='margin-top: 10px; margin-bottom: 20px;' name="transactionform2[{{ $key }}][nextofkinfileback]" class="form-control" id='nextofkinfilefront'>
                                        </div>
                                    @endif
                                @endforeach
                                <br />
                                ...
                                <tr>
                                    <td>
                                        @if(!empty($model->hasAllotteeFiles->childrenbform))
                                            @if(explode('.', $model->hasAllotteeFiles->childrenbform)[1]=='pdf')
                                                <embed src="{{ url('/public/alloteefiles/'.$model->hasAllotteeFiles->childrenbform) }}" type="application/pdf" style='height:300px; width:600px; margin-bottom: 5px;' />
                                            @else
                                    ...
                                    <td>
                                        @if(!empty($model->hasAllotteeFiles->promotion_letter))
                                            @if(explode('.', $model->hasAllotteeFiles->promotion_letter)[1]=='pdf')
                                                <embed src="{{ url('/public/alloteefiles/'.$model->hasAllotteeFiles->promotion_letter) }}" type="application/pdf" style='height:300px; width:600px; margin-bottom: 5px;' />
                                            @else
                                    ...
                                    <td>
                                        @if(!empty($model->hasAllotteeFiles->fpaform))
                                            @if(explode('.', $model->hasAllotteeFiles->fpaform)[1]=='pdf')
                                                <embed src="{{ url('/public/alloteefiles/'.$model->hasAllotteeFiles->fpaform) }}" type="application/pdf" style='height:300px; width:600px; margin-bottom: 5px;' />
                                            @else
                                    ...
                                    <td>
                                        @if(!empty($model->hasAllotteeFiles->applicant_photograph))
                                            @if(explode('.', $model->hasAllotteeFiles->applicant_photograph)[1]=='pdf')
                                                <embed src="{{ url('/public/alloteefiles/'.$model->hasAllotteeFiles->applicant_photograph) }}" type="application/pdf" style='height:300px; width:600px; margin-bottom: 5px;' />
                                            @else
                                    ...
                                    <td>
                                        @if(!empty($model->hasAllotteeFiles->frp_fc))
                                            @if(explode('.', $model->hasAllotteeFiles->frp_fc)[1]=='pdf')
                                                <embed src="{{ url('/public/alloteefiles/'.$model->hasAllotteeFiles->frp_fc) }}" type="application/pdf" style='height:300px; width:600px; margin-bottom: 5px;' />
                                            @else
                                    ...
                                    <td>
                                        @if(!empty($model->hasAllotteeFiles->draft_cheque))
                                            @if(explode('.', $model->hasAllotteeFiles->draft_cheque)[1]=='pdf')
                                                <embed src="{{ url('/public/alloteefiles/'.$model->hasAllotteeFiles->draft_cheque) }}" type="application/pdf" style='height:300px; width:600px; margin-bottom: 5px;' />
                                            @else
...
<Script>
    ...
    $(document).ready(function(){
        ...
        else if (checked == 'uniform') {
          $('.uniform-input').show();
          $('.civilian-input').hide();
        }
    });

    //Civilian & uniform if change
    ...
    //Delete Images of cnic next of kins
    ...
    $('#d_o_c').on('change', function() {
        var date_of_probationary_completion = $(this).val();
        var date_of_enrolment = $('#d_o_e').val();
        if (date_of_probationary_completion <= date_of_enrolment) {
            $('#error-doc').text('* Probationary date can not be less than enrolment...!');
            $(this).val('');
            return false;
        } else {
            $('#error-doc').text('');
    ...
    //Calculating Service of uniform
      $('#d_o_sos_date').on('change', function(){
        ...
        var years = sos.diff(probation, 'year');
        probation.add(years, 'years');

        var months = sos.diff(probation, 'months');
        probation.add(months, 'months');

        var days = sos.diff(probation, 'days');

        $('#service').val('( '+years+' year '+months+' month '+days+' days )');
      });
      ...
      $('#d_o_s_date').on('change', function(){
        ...
        var years = dos.diff(dob, 'year');
        dob.add(years, 'years');

        var months = dos.diff(dob, 'months');
        dob.add(months, 'months');

        var days = dos.diff(dob, 'days');
    ...
    $(document).on('click', '.add-more-next-of-kins', function() {
        ...
        html += "<tr class='transaction_row2' id='add-next-of-kin'>" +
            "<td>" +
            "<input type='text' id='name' name='nextkins[" + counter +
            "][name]' class='form-control' placeholder='Enter Name'>" +
            "</td>" +
            "<td>" +
            ...
            "</td>" +
            "<td>" +
            "<textarea id='define-other' name='nextkins[" + counter +
            "][define_other]' class='form-control' placeholder='Define? if choose Other from relation' ></textarea>" +
            "</td>" +
            "<td>" +
            "<input type='text' id='next-kin-cnic' name='nextkins[" + counter +
            "][cnic]' maxlength='15' class='form-control cnicrelation cnic next-kin-cnic' placeholder='12345-1234567-1'>" +
            "</td>" +
            "<td>" +
            "<input type='text' id='mobileno' name='nextkins[" + counter +
            "][mobilenumber]' maxlength='12' class='form-control next-kin-mobile' placeholder='1234-1234567'>" +
            "</td>" +
            "<td>" +
            "<input type='number' class='form-control' name='nextkins[" + counter +
            "][country_code]' placeholder='Enter country code'>" +
            "</td>" +
            "<td>" +
        ...
        html += "</select>" +
            ...
            "</td>" +
            "<td>" +
            "<textarea id='kinaddress' name='nextkins[" + counter +
            "][kinaddress]' class='form-control' placeholder='Enter kinaddress'></textarea>" +
            "</td>" +
            "<td class='text-center'>" +
            "<button type='button' data-counter=" + counter +
            " class='btn btn-success add-more-next-of-kins'><i class='fa fa-plus'></i></button>" +
    ...
    $(document).on('keydown', '.next-kin-mobile', function() {
        ...
        var newArray = localNumber.match(/^(92|)?(\d{3})(\d{3})(\d{4})$/);
    ...
    $(document).on('click', '.add-more-next-kin-cnic', function() {
        ...
        var html = "<tr class='transaction_row2'>" +
            "<td>" +
            "<input type='file' name='transactionform2[" + counter +
            "][nextofkinfilefront]' class='form-control' id='nextofkinfilefront' multiple='multiple' accept='image/x-png,image/gif,image/jpeg'>" +
            "</td>" +
            "<td>" +
            "<input type='file' name='transactionform2[" + counter +
            "][nextofkinfileback]' class='form-control' id='nextofkinfileback'  multiple='multiple' accept='image/x-png,image/gif,image/jpeg'>" +
            "</td>" +
            "<td class='text-center'>" +
