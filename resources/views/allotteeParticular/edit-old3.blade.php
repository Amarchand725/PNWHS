                ...
                <div class="tab-pane active" id="applicant-info">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            @if($model->reg_file_no=='')
                                |Last Allotted File Number: <b>{{ $last_alloted_file_no->reg_file_no }}</b>
                            @endif
                        ...
                        <span style='color:red'>*</span>
                        <div class="form-group">
                            <input type="date" class='form-control' value='{{ $model->membership_date }}' name='membership_date' id='membership_date' require>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <span style='color:red'>*</span>
                            <div class="form-group">
                                <input type="date" class='form-control' value='{{ $model->d_o_b }}' name='d_o_b'
                                    id='d_o_b'>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <span style='color:red'> *</span>
                            <div class="form-group">
                                <input type="date" class='form-control' value='{{ $model->d_o_e }}' name='d_o_e'
                                    id='d_o_e'>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <span style='color:red'> *</span>
                            <div class="form-group">
                                <input type="date" class='form-control' value='{{ $model->d_o_c }}' name='d_o_c'
                                    id='d_o_c'>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <span style='color:red'> *</span>
                            <div class="form-group">
                                <input type="date" class='form-control' value='{{ $model->d_o_p }}' name='d_o_p'
                                    id='d_o_p'>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <span style='color:red'> *</span>
                            <div class="form-group">
                                <input type="date" class='form-control' value='{{ $model->d_o_sod }}' name='d_o_sod'
                                    id='d_o_sod'>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 uniform-input">
                            ...
                            <div class="form-group">
                                <input type="date" class='form-control' value='{{ $model->d_o_sos }}' name='d_o_sos'
                                    id='d_o_sos'>
                            </div>
