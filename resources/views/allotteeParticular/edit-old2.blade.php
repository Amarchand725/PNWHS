...
<Script>
    ...
    //Calculating Service
    $('#d_o_s').on('change', function() {
        var date_of_probationary_completion = $('#d_o_c').val();
        var today = new Date();
        var probationary_complete_date = new Date(date_of_probationary_completion);
        var service = today.getFullYear() - probationary_complete_date.getFullYear();
        $('#service').val(service + ' Year(s)');
    });
