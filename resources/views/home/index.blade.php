              ...
              <div class="stat">
                <div class="row">
                  ...
                  <div class="col-xs-8">
                    ...
                    <h1>{{ $total_plots-($total_built_houses+$total_progress_houses) }}</h1>
                  </div>
                </div><!-- row -->
                <div class="mb15"></div>
              </div><!-- stat -->
          ...
          <div class="panel panel-primary panel-stat">
            <div class="panel-heading">
              <div class="stat">
                <div class="row">
                  <div class="col-xs-4">
                    <img src="{{url('')}}/public/images/plotlogo.png" alt="" style="width: 50px" />
                  </div>
                  <div class="col-xs-8">
              ...
              <div class="stat">
                <div class="row">
                  ...
                  <div class="col-xs-8">
                    ...
                    <h1>{{ $total_members-$total_active_members }}</h1>
                  </div>
                </div><!-- row -->
                <div class="mb15"></div>
              </div><!-- stat -->
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <div class="panel panel-info panel-stat">
            <div class="panel-heading">
              <div class="stat">
                <a href="{{ url('Payment') }}" style='color:white' data-toggle="tooltip" data-placement="top" title="Display payment ledger">
                  <div class="row">
                    <div class="col-xs-4">
                      <img src="{{url('')}}/public/images/construction.png" alt="" style="width: 60px" />
                    </div>
                    <div class="col-xs-8">
                    <span style='font-size:20px'>Payment Ledger</span><br />
                    <span style='font-size:20px'>{{ $members_total_amount }}</span>
                    </div>
                  </div>
                </a>
                <div class="mb15"></div>
