...
<div class="panel panel-dark">
	...
	<div class="panel-body">
			...
			<div class="col-md-6 col-sm-6">
				<div class="form-group">
					...
					<select name="category" class="form-control" id="" required>
						...
						<option value="A" {{ $model->category=='A'?'selected':'' }}>A</option>
						<option value="B" {{ $model->category=='B'?'selected':'' }}>B</option>
						<option value="C" {{ $model->category=='C'?'selected':'' }}>C</option>
						<option value="D" {{ $model->category=='D'?'selected':'' }}>D</option>
						<option value="E" {{ $model->category=='E'?'selected':'' }}>E</option>
					</select>
		...
		<div class="row">
			<div class="col-md-6 col-sm-6">
				<div class="form-group">
					{!! Form::label("Initial Price", "Initial Price:", ["class" => "control-label"]) !!}
                    {!! Form::text("initial_price", null, ["class" => "form-control", "Placeholder" => "Enter Initial Price"]) !!}
				</div>
			</div>

            <div class="col-md-6 col-sm-6">
				<div class="form-group">
					{!! Form::label("Final Price", "Final Price:", ["class" => "control-label"]) !!}
