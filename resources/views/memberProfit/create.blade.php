...
<div class="row">
    <div class="col-sm-6">
        ...
        {!! Form::number("rate", null, ["class" => "form-control", "placeholder" => "Enter Profit Rate (%)"]) !!}</div>
    </div>
    <div class="col-sm-6">
        <div class="form-group">
...
<div class="row">
    <div class="col-sm-6">
        <div class='form-group'>{!! Form::submit('Create New MemberProfit', ['class' => 'btn btn-primary']) !!}</div>
    </div>
</div>
