		...
		<div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <span style='color:red'>*</span>
                    <div class="form-group">
                        <input type="date" class='form-control' name='d_o_p' value='{{ old("d_o_p") }}' id='d_o_p' required>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <span style='color:red'>*</span>
                    <div class="form-group">
                        <input type="date" class='form-control' name='d_o_sod' value='{{ old("d_o_sod") }}' id='d_o_sod' required>
                    </div>
                ...
                <div class="col-md-6 military-input" style='display:none'>
                    ...
                    <div class="form-group">
                        <input type="date" class='form-control' name='d_o_sos' value='{{ old("d_o_sos") }}' id='d_o_sos'>
                    </div>
                ...
                <div class="col-md-6 civilian-input">
                    ...
                    <div class="form-group">
                        <input type="date" class='form-control' name='d_o_s' value='{{ old("d_o_s") }}' id='d_o_s'>
                    </div>
