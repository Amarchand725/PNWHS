            ...
            <div class="col-sm-6">
              <table class='table'>
                ...
                <tr>
                  ...
                  <td>
                    @if($member_details->payment_status==1)
                      <span class='label label-success'><i class='fa fa-check'></i>{{ date('d-F-Y', strtotime($member_details->active_date)) }}</span>
                    @else
                      <span class='label label-danger'><i class='fa fa-times'></i> In Active</span>
                    @endif
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    {{ number_format($policy->hasPaymentPolicy->registration_payment) }}
                    </span>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <span class='label label-primary'>
                      {{ number_format($policy->hasPaymentPolicy->insurance_payment) }}
                  </td>
                </tr>
                    ...
                    <tr>
                      ...
                      <th>
                        <span class='label label-success'>
                          {{ number_format($current_monthly_policy->hasPaymentPolicy->monthly_instalment) }}
                        </span>
                      </th>
                    </tr>
                  @endif
                  ...
                  <tr>
                    ...
                    <td>
                      <span class='label label-danger'>
                        @if($member_details->payment_status==1)
                            {{ number_format($total_payabale) }}
                        @else
                          {{ $policy->payable_amount-$reg_insurance_total_paid }}
                        @endif
                      </span>
                    </td>
                  </tr>
                    ...
                    <td>
                      <span class='label label-info'>
                        @if(!empty($last_trasaction))
                          {{ number_format($last_trasaction->current_paid) }}
                        @else
                          {{ '0' }}
                        @endif
                      </span>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class='label label-primary'>
                        @if(!empty($last_trasaction))
                          @if($member_details->payment_status == 1)
                            {{ number_format($total_monthly_paid)}}
                          @else
                            {{ number_format($reg_insurance_total_paid)}}
                          @endif
                        @else
                          {{ '0' }}
                        @endif
