				...
				<table class="table table-bordered table-resposive" style='width:100% !important'>
					<tbody>
						...
						<tr>
							...
							<td style='border:1px solid black; !important;'>{{ $member_info->hasPromotedMember->soldier??'N/A' }}</td>
							<td style='border:1px solid black; !important;'>{{ $member_info->hasPromotedMember->rank_rate??'N/A' }}</td>
						</tr>
						<tr>
                        ...
                        @foreach($models as $model)
							...
							<tr>
								...
								<td colspan='2' style='border:1px solid black;width:5% !important;'>{{ $model->remarks??'N/A' }}</td>
							</tr>
						@endforeach
						<tr>
