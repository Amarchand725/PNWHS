				...
				<table class="table table-bordered table-resposive" style='width:100% !important'>
					<tbody>
						<tr>
							...
							<th style='border:1px solid black; background-color:#1d2939; color:white; !important;' colspan="5">Category</th>
						</tr>
						<tr>
							...
							<td style='border:1px solid black;width:10% !important;'>{{ $member_info->reg_file_no??'N/A' }}</td>
							<td style='border:1px solid black; !important;' colspan="5">{{ $member_info->hasRank->hasHouseCategory->name??'--' }}</td>
						</tr>
						<tr>
							<th style='border:1px solid black;width:10%; background-color:#1d2939; color:white; !important;'>S.No#</th>
							<th style='border:1px solid black;width:10%; background-color:#1d2939; color:white; !important;'>Voucher No#</th>
							...
							<th style='border:1px solid black;width:10%; background-color:#1d2939; color:white; !important;'>Current Installment</th>
                        ...
                        @foreach($models as $model)
							...
							<tr>
								...
								<td style='border:1px solid black;width:10% !important;'>{{ $model->voucher_no }}</td>
								...
								@if($model->is_active==1)
									{{ number_format($member_info->hasRank->hasPolicy->hasPaymentPolicy->monthly_instalment) }}
								@else
									0
								@endif
