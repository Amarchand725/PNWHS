		...
		<div class="panel-body" >
			...
			<div class="row" style='width:100% !important'>
				<table class="table table-bordered table-resposive" style='width:100% !important'>
					<tbody>
						<tr>
							<th style='border:1px solid black;width:20%; background-color:#1d2939; color:white; !important;'>P/PJO/O</th>
							<th style='border:1px solid black;width:20%; background-color:#1d2939; color:white; !important; '>Name</th>
							<th style='border:1px solid black;width:20%; background-color:#1d2939; color:white; !important;'>Rank/Rate</th>
							<th style='border:1px solid black;width:20%; background-color:#1d2939; color:white; !important;'>File Number</th>
							<th style='border:1px solid black;width:20%; background-color:#1d2939; color:white; !important;'>Cat</th>
						</tr>
						<tr>
							<td style='border:1px solid black;width:20% !important;'>{{ $member_info->p_no }}</td>
							<td style='border:1px solid black;width:20% !important;'>{{ $member_info->name }}</td>
							<td style='border:1px solid black;width:20% !important;'>
								@if(!empty($member_info->hasPromotedMember))
									{{ $member_info->hasPromotedMember }}
								@else
									{{ $member_info->hasRank->name }}
								@endif
							</td>
							<td style='border:1px solid black;width:20% !important;'>{{ $member_info->reg_file_no??'N/A' }}</td>
							<td style='border:1px solid black;width:20% !important;'>{{ $member_info->hasRank->hasHouseCategory->name??'--' }}</td>
						</tr>
						<tr>
							<th style='border:1px solid black;width:20%; background-color:#1d2939; color:white; !important;'>S No</th>
							<th style='border:1px solid black;width:20%; background-color:#1d2939; color:white; !important; '>Date</th>
							<th style='border:1px solid black;width:20%; background-color:#1d2939; color:white; !important;'>Payment Type</th>
							<th style='border:1px solid black;width:20%; background-color:#1d2939; color:white; !important;'>Payment Made(Rs)</th>
							<th style='border:1px solid black;width:20%; background-color:#1d2939; color:white; !important;'>Remaining Dues/Over Paid Amount</th>
						</tr>
