			...
			<div class="row" style='width:100% !important'>
				<table class="table table-bordered table-resposive" style='width:100% !important'>
					<tbody>
						...
						<tr>
							<td style='border:1px solid black;width:10% !imhasHouseCategoryportant;'>
							...
							<td style='border:1px solid black;width:10% !important;'>
								@if(!empty($member_info->hasPromotedMember))
									{{ $member_info->hasPromotedMember->hasPromotedRank->name??'N/A' }}
								@else
									{{ $member_info->hasRank->name??'N/A' }}
								@endif
							</td>
							<td style='border:1px solid black;width:10% !important;'>
								@if(!empty($member_info->hasPromotedMember))
							...
							<td style='border:1px solid black; !important;' colspan="4">
								@if(!empty($member_info->hasPromotedMember))
									{{ $member_info->hasPromotedMember->hasPromotedRank->hasHouseCategory->name??'N/A' }}
								@else
									{{ $member_info->hasRank->hasHouseCategory->name??'N/A' }}
								@endif
							</td>
						</tr>
						<tr>
