...
Route::group(['middleware' => 'auth'], function() {
    ...
    Route::post('getcontractor','AllotteeParticularController@getContractor');
    ...
    Route::get('block_delete/{id}', 'BlockController@blockDelete');
    Route::resource('Contractor', 'ConstructorController');
    Route::get('Contractor/destroy/{id}', 'ConstructorController@destroy');
    Route::get('delete_contractor/{id}', 'ConstructorController@deleteContractor');
    ...
    Route::get('delete_constraction/{id}', 'ConstructionController@deleteConstraction');
    ...
    Route::get('delete_rank/{id}', 'RankController@deleteRank');
    Route::resource('PaymentPolicy', 'PaymentPolicyController');
    Route::get('delete_payment_policy/{id}', 'PaymentPolicyController@deletePaymentPolicy');
    ...
    Route::get('delete_house_cost/{id}', 'HouseCostController@deleteHouseCost');
    ...
    Route::get('delete_profit_rate/{id}', 'MemberProfitController@deleteProfitRate');

    Route::get('/get_profit/{id}', 'GetProfitController@getProfit');
    ...
    Route::get('delete_uplodated_file/{id}', 'CsvFileController@deleteUplodatedFile');
    ...
    Route::get('/delete_promoted_member/{id}', 'PromotedMemberController@deletePromotedMember');
    Route::get('/delete_membership_application/{id}', 'AllotteeParticularController@deleteMembershipApplication');
});
...
Route::post('/calculate_service', 'AllotteeParticularController@calculateService');
Route::get('/reciept/{id}', 'GetProfitController@reciept');
